...
print("\n===== RF LODO BENCHMARK (WITH DATA SCALING) =====")
...
df_results.to_csv("rf_lodo_dataset_results_with_pct.csv", index=False)

print("\nSaved: rf_lodo_dataset_results_with_pct.csv")